    ...
    return(
        <div className="flex w-full flex-col bg-muted/40">
               ...
               <nav className='flex flex-col items-center gap-4 px-2 py-5'>
                <TooltipProvider>
                  ...
                  <Tooltip>
                    ...
                    <span className='sr-only'>Clintes</span>
                    </Link>
                    </TooltipTrigger>
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent side="right">Configutações</TooltipContent>
                  </Tooltip>
               </TooltipProvider> 
               </nav>
           ...
           <div className="sm:hidden flex flex-col sm:gap-4 sm:pl-14">
             <header className='stick top-0 z-30 flex h-14 items-center px-4 border-b bg-background gap-4 sm:static 
                        ...
                        <nav className='grid gap-6 text-lg font-medium'>
                            <Link 
                              href="#"
                               ...
                               text-lg items-center justify-center text-primary-foreground md:text-base gap-2'
                               prefetch={false}
                              >
